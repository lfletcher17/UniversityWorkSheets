 ...
 *  read in from a file. It contains methods to crop the left upper
 *  half of the picture and write it out again, to compress the picture
 *  by quartering the number of pixels and write it out again, to rotate the
 *  picture 90 degrees and write it out again and to convert the picture to black
 *  and white and write it out again.
 *
 *  @version 2017-11-01
...
public class PGMImage{
    ...
    /**
     *  Method compresses the image by quartering the number of pixels.
     *  @param filename The filename of the file in which the compressed
     *  image should be saved.
     */
    ...
    /**
     *  Method rotates the image clockwise by 90 degrees.
    ...
    /**
     *  Method converts the image to black and white.
